	...
	<section class="content">
	      <div class="row">
	        <div class="col-xs-12">
                ...
                <form class="form-horizontal" action="{{ route('rooms.store') }}" method="POST">
                	{{ csrf_field() }}
                  <div class="form-group">
                    <label for="inputNumber" class="col-sm-3 control-label">Number</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputNumber" placeholder="Room Number" value="{{ old('number') }}" required name="number">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="tel" class="form-control" id="inputCapacity" placeholder="Capacity" value="{{ old('capacity') }}" required name="capacity">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <label class="text-success col-sm-3">
                        <input type="radio" name="AC" class="minimal-green" required value="1">
                        Yes
                      </label>
                      <label class="text-danger col-sm-3">
                        <input type="radio" name="AC" class="minimal-red" required value="0">
                        No
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <label class="text-success col-sm-3">
                        <input type="radio" name="projector" class="minimal-green" required value="1">
                        Yes
                      </label>
                      <label class="text-danger col-sm-3">
                        <input type="radio" name="projector" class="minimal-red" required value="0">
                        No
                      </label>
                    </div>
                  </div>
