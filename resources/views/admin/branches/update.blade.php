	...
	<section class="content">
	      <div class="row">
	        <div class="col-xs-12">
                ...
                <form class="form-horizontal" action="{{ url('/admin/branches/' . $branch->code . '/edit') }}" method="POST">
                	{{ csrf_field() }}
                  {{ method_field('PATCH') }}
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputName" placeholder="Branch Name" value="{{ $branch->name }}" required name="name">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputCapacity" placeholder="Capacity of Rooms" value="{{ $branch->room_number }}" required name="room_number">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputAddress" placeholder="Address" value="{{ $branch->address }}" required name="address">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="tel" class="form-control" id="inputNumber" placeholder="Mobile Number" value="{{ $branch->mobile_number }}" required name="mobile_number">
                    </div>
                  </div>
