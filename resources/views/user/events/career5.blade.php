...
@section('head')
    <link rel="stylesheet" href="{{ asset('/user_style/css/events/career.css') }}">
@endsection
                            ...
                            <div class="sponsors">
                                <div class="row">
                                    ...
                                    @foreach ($brands as $brand)
                                        <div class="col-6 col-sm-4 col-md-3 col-lg-2"><img class="img-fluid" src="{{ asset("/user_style/images/brands/" . $brand) }}"></div>
                                    @endforeach
...
@endsection
    <script src="{{ asset('/user_style/js/events/career.js') }}"></script>
@section('footer')
