...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $highboard20_count = Highboard20::all()->count();
        ...
        return view('admin.home', compact('memberssecond_count','opening_count', 'highway_count', 'highboard20_count', 'participants_count', 'first', 'second', 'days_dist', 'iqs_dist_days', 'iqs_dist_hours', 'first_member', 'second_member', 'career6_count', 'sessions_rate', 'career6_days_dist', 'career6_hours_dist'));
    }
}
